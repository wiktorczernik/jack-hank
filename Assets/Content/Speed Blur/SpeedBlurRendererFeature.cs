...
public sealed class SpeedBlurRendererFeature : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        if (m_Material == null)
            m_Material = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/SpeedBlur");
#endif
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        SpeedBlurVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<SpeedBlurVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            if (myVolume != null)
            {
                s_SharedPropertyBlock.SetFloat("_Width", myVolume.Width.value);
                //s_SharedPropertyBlock.SetFloat("_Level", myVolume.Level.value);
            }
