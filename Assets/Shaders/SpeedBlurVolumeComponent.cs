...
[VolumeComponentMenu("Post-processing Custom/SpeedBlur")]
[VolumeRequiresRendererFeatures(typeof(SpeedBlurRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class SpeedBlurVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public SpeedBlurVolumeComponent()
    {
        displayName = "SpeedBlur";
    }

    public ClampedFloatParameter Level = new ClampedFloatParameter(1f, 0f, 1f);
    public IntParameter Width = new IntParameter(230);

    public BoolParameter ForceDisable = new BoolParameter(false);
    //public TextureParameter BlurMap;

    public bool IsActive()
    {
        return Width.value > 0 && !ForceDisable.value;
    }
}
